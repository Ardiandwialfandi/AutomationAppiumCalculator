...
public class CalculatorMultiply {
    ...
    public static void locatorCalculator() {
        MobileElement three = driver.findElementById("com.google.android.calculator:id/digit_3");
        MobileElement multiply = driver.findElementById("com.google.android.calculator:id/op_mul");
        MobileElement four = driver.findElementById("com.google.android.calculator:id/digit_4");
    ...
    public static void closePageMultiply(){
        driver.quit();
    }
